...
class DeformNetwork(nn.Module):
    ...
    # D=10, W=512 works slightly better than D=10, W=256 for car3-dynamic
    def __init__(self, D=10, W=256, input_ch=3, output_ch=59, multires=10, is_blender=False, is_6dof=False):
